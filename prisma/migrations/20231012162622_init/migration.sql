-- CreateEnum
CREATE TYPE "BookingStatus" AS ENUM ('pending', 'fixing', 'fixed');
...
-- AddForeignKey
ALTER TABLE "admins" ADD CONSTRAINT "admins_superAdminId_fkey" FOREIGN KEY ("superAdminId") REFERENCES "super_admins"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "services" ADD CONSTRAINT "services_adminId_fkey" FOREIGN KEY ("adminId") REFERENCES "admins"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
